...
Plugin URI: https://www.laojiang.me/5955.html
...
if (version_compare(PHP_VERSION, '7.4.0', '<')) {
    add_action('admin_notices', function () {
        echo '<div class="notice notice-error"><p>WPQiNiu 插件需要 PHP 7.4 或更高版本，当前版本：' . esc_html(PHP_VERSION) . '。请升级 PHP 后启用插件。</p></div>';
    });
    return;
}
